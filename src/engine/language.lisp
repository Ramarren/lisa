...
;;;
;;; $Id: language.lisp,v 1.58 2002/05/22 21:03:24 youngde Exp $
...
(defmacro defimport (class-name &key (package 'lisa-user)
                                     (use-inheritancep nil))
  `(import-class ',class-name ,package ,use-inheritancep))
