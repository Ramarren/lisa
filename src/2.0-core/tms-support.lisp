...
;;; $Id: tms-support.lisp,v 1.1 2002/11/13 16:06:31 youngde Exp $
...
(define-symbol-macro scheduled-depenencies *scheduled-dependencies*)

(defmacro with-truth-maintenance (&body body)
  `(let ((*scheduled-dependencies* nil))
     ,@body))
